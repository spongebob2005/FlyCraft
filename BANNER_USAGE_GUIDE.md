...
```html
<div align="center">
  <img src="./assets/cover-banner.svg" alt="FlyCraft 1.0 Banner" width="1200" height="630">
</div>
```
...
```markdown
![FlyCraft 1.0 Banner](./assets/cover-banner.svg)
```
...
4. Description:
   ```
   ![FlyCraft 1.0](./assets/cover-banner.svg)
...
```markdown
![FlyCraft 1.0 Banner](https://raw.githubusercontent.com/your-username/FlyCraft/main/assets/cover-banner.svg)
